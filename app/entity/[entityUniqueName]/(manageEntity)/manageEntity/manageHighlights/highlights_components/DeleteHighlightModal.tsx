...
export default function DeleteHighlightModal(
  props,
  { params }: { params: { entityUniqueName: string } }
) {
              ...
              <Dialog.Panel className="relative mb-52 transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:rounded-lg">
                ...
                <div className="flex items-center justify-end space-x-5 bg-gray-50 px-4 py-3 sm:justify-end sm:space-x-0 sm:px-6 ">
                  <div className="space-x-3 sm:space-x-3">
                    ...
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-3xl border border-transparent bg-amethyst px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-amethyst focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
